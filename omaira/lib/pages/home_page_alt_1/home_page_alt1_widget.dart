                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed(MYBudgetsWidget.routeName);
                                },
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      Row(
                        ...
                        children: [
                          StreamBuilder<List<SalesByProductRecord>>(
                            stream: querySalesByProductRecord(
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<SalesByProductRecord>
                                  textSalesByProductRecordList = snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final textSalesByProductRecord =
                                  textSalesByProductRecordList.isNotEmpty
                                      ? textSalesByProductRecordList.first
                                      : null;
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'dfjtbkbo' /* Top Ventas ultimos 7 dias */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleLarge
                                  .override(
