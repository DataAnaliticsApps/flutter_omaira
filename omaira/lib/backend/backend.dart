...
import 'schema/sales_by_product_record.dart';
...
export 'schema/sales_by_product_record.dart';
...
/// Functions to query SalesByProductRecords (as a Stream and as a Future).
Future<int> querySalesByProductRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SalesByProductRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SalesByProductRecord>> querySalesByProductRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SalesByProductRecord.collection,
      SalesByProductRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SalesByProductRecord>> querySalesByProductRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
